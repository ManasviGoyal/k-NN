...
public class VectorDataTypeTests extends KNNTestCase {
    ...
    private static final float[] SAMPLE_HALF_FLOAT_VECTOR_DATA = new float[] { 10.0f, 25.0f };
    ...
    public void testGetDocValuesWithHalfFloatVectorDataType() {
        ...
        scriptDocValues.setNextDocId(0);
        Assert.assertArrayEquals(SAMPLE_HALF_FLOAT_VECTOR_DATA, scriptDocValues.getValue(), 0.1f);
    ...
    private void createKNNHalfFloatVectorDocument(Directory directory) throws IOException {
        ...
        IndexWriter writer = new IndexWriter(directory, conf);
        Document knnDocument = new Document();
        BytesRef bytesRef = new BytesRef(KNNVectorAsCollectionOfHalfFloatsSerializer.INSTANCE.floatToByteArray(SAMPLE_HALF_FLOAT_VECTOR_DATA));
