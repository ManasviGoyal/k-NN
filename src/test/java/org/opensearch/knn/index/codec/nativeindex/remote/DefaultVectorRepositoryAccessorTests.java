...
public class DefaultVectorRepositoryAccessorTests extends RemoteIndexBuildTests {
    ...
    /**
     * Test that HALF_FLOAT also uses the fast AsyncMultiStreamBlobContainer path - the Lucene bug
     * (apache/lucene#14992) gating this to FLOAT-only is specific to MergedByteVectorValues (BYTE/BINARY);
     * HALF_FLOAT rides on Lucene's FloatVectorValues under the hood, same as FLOAT.
     */
