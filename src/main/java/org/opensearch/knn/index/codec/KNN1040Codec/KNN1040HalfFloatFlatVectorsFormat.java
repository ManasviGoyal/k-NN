 ...
 *
 * <p>The writer side lands in a follow-up PR; {@link #fieldsWriter} is a placeholder until then.
 */
public class KNN1040HalfFloatFlatVectorsFormat extends FlatVectorsFormat {
    ...
    public FlatVectorsWriter fieldsWriter(SegmentWriteState state) throws IOException {
        throw new UnsupportedOperationException("KNN1040HalfFloatFlatVectorsWriter is not yet implemented");
    }
