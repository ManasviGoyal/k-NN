...
class KNN1040HalfFloatFlatVectorsValues extends FloatVectorValues implements HasIndexSlice {
     ...
     * non-mmap SIMD tier ({@link KNN1040HalfFloatVectorScorer.HalfFloatRandomVectorScorer}, raw FP16
     * bytes passed to native SIMD) for similarities with a native type, or the Java decode tier
     * otherwise. Flip to false to restore normal behaviour.
     */
