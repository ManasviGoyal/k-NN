...
public class KNNVectorsFormatParams {
    ...
    public KNNVectorsFormatParams(final Map<String, Object> params, int defaultMaxConnections, int defaultBeamWidth, SpaceType spaceType, VectorDataType vectorDataType) {
