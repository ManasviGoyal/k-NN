...
public interface Encoder {
    ...
    enum QuantizationBits {
         ...
         */
        public static CompressionLevel getCompressionLevel(QuantizationBits bits, VectorDataType vectorDataType) {
            ...
            return bits.compressionLevel;
        }

        /**
         * Data-type-aware inverse of {@link #getCompressionLevel(QuantizationBits, VectorDataType)}.
