    ...
    private void reentrantSearch(
        ...
        if (secondDeepDiveTasks.isEmpty() == false) {
            ...
            final ReentrantKnnCollectorManager reentrantCollectorManager = new ReentrantKnnCollectorManager(
                collectorManager,
                segmentOrdToResults,
                knnQuery.getVectorDataType() == VectorDataType.FLOAT || knnQuery.getVectorDataType() == VectorDataType.HALF_FLOAT ? knnQuery.getQueryVector() : knnQuery.getByteQueryVector(),
                knnQuery.getField()
            );
